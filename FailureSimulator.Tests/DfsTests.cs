...
namespace FailureSimulator.Tests
{
    ...
    public class DfsTests
    {
        ...
        {
            var graph = new Graph();
            var v0 = graph.AddVertex(new GraphUnit("0"));
            var v1 = graph.AddVertex(new GraphUnit("1"));
            var v2 = graph.AddVertex(new GraphUnit("2"));
            var v3 = graph.AddVertex(new GraphUnit("3"));
            graph.AddEdge("0", "1");
            graph.AddEdge("0", "2");
            graph.AddEdge("2", "1");
            graph.AddEdge("1", "3");
            ...
            var expectedPathes = new List<List<GraphUnit>>()
            {
                new List<GraphUnit>() {v0, v1, v3},
                new List<GraphUnit>() {v0, v2, v1, v3},
            };
        ...
        public void FindPath_2()
        {
            ...
            var expectedPathes = new List<List<GraphUnit>>()
            {
                ...
                new List<GraphUnit>() {v3, v1, v0, v2},
                new List<GraphUnit>() {v3, v1, v2}
            };
    ...
    class PathComparer : IComparer
    {
        ...
        {
            var pathX = (IReadOnlyList<GraphUnit>) x;
            var pathY = (IReadOnlyList<GraphUnit>) y;
