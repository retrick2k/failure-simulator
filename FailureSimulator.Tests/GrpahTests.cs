...
namespace FailureSimulator.Tests
{
    ...
    public class GrpahTests
    {
        ...
        {
            var graph = new Graph();
            var vertex = new GraphUnit("vertex1");
        ...
        public void AddVertex_fail_nameAlreadyExists()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => graph.AddVertex(new GraphUnit("vertex1")));
        }
        ...
        public void AddEdge_byVertexRef_ok()
        {
            ...
            Assert.AreSame(vertex2, graph.Vertex[0].Edges[0].GraphUnit);
        ...
        public void AddEdge_byVertexRef_ok_sameNameDifferentRefs()
        {
            ...
            var vertex2 = new GraphUnit("vertex2");
            graph.AddVertex(vertex1);
            graph.AddVertex(new GraphUnit("vertex2"));
        ...
        public void AddEdge_byVertexRef_fail_vertexNull()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => graph.AddEdge(null as GraphUnit, vertex2));
            Assert.ThrowsException<ArgumentNullException>(() => graph.AddEdge(vertex1, null as GraphUnit));
            Assert.ThrowsException<ArgumentNullException>(() => graph.AddEdge(null as GraphUnit, null as GraphUnit));
        }
        ...
        public void RemoveVertex_byVertexRef_ok_sameNameDifferentRefs()
        {
            ...
            graph.RemoveVertex(new GraphUnit("vertex2"));
            Assert.AreEqual(1, graph.Vertex.Count);
            Assert.AreSame(vertex2, graph.Vertex[0]);
            Assert.AreEqual(0, graph.Vertex[0].Edges.Count); // Ребра 2-1 нет
        }
        ...
        public void RemoveVertex_byVertexRef_fail_vertexNull()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => graph.RemoveVertex(null as GraphUnit));
        }
        ...
        public void RemoveVertex_byVertexRef_fail_noVertex()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => graph.RemoveVertex(new GraphUnit("vertex3")));
        }
        ...
        public void GetVertexIndex_byVertexRef_ok_sameNameDifferentRefs()
        {
            ...
            Assert.AreEqual(0, graph.GetVertexIndex(new GraphUnit("vertex1")));
        }
        ...
        public void GetVertexIndex_byVertexRef_fail_vertexNull()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => graph.GetVertexIndex(null as GraphUnit));
        }
        ...
        public void GetVertexIndex_byVertexRef_fail_noVertex()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => graph.GetVertexIndex(new GraphUnit("vertex2")));
        }
